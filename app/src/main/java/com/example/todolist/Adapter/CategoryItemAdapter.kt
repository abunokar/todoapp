...
class CategoryItemAdapter(categories: MutableList<CategoryItem>?, context: Context) :
    PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        view.setOnClickListener {
            ...
            val options = ActivityOptions.makeSceneTransitionAnimation(
                ...
                UtilPair.create(
                    imageView,
                    context.resources.getString(R.string.transition_category_image)
                ),
                UtilPair(
                    titleView,
                    context.resources.getString(R.string.transition_category_title)
                ),
                UtilPair(
                    tasksView,
                    context.resources.getString(R.string.transition_category_taskcount)
                ),
                UtilPair(
                    progressBar,
                    context.resources.getString(R.string.transition_category_progress_bar)
                ),
                UtilPair(
                    percentageView,
                    context.resources.getString(R.string.transition_category_percentage)
                )
            )
            context.startActivityForResult(
                intent,
                MainActivity.REQUEST_FOR_ACTIVITY_CODE,
                options.toBundle()
            )
        }
